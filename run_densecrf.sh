...
SAVE_DIR=/home/rasha/work/deeplab-public-ver2/drusen_area/features/RESNET-50/val/small/snapshot_/post_densecrf

echo "SAVE TO ${SAVE_DIR}"

#CRF_DIR=/rmt/work/deeplab/code/densecrf
CRF_DIR=/home/rasha/work/deeplab-public-ver2/densecrf
...
IMG_DIR=/home/rasha/Desktop/example
...
#    FEATURE_DIR=/rmt/work/deeplab/exper/${DATASET}/${FEATURE_NAME}/${MODEL_NAME}/${TEST_SET}/${FEATURE_TYPE}
	FEATURE_DIR=/home/rasha/work/deeplab-public-ver2/drusen_area/features/RESNET-50/val/small/snapshot_
else
